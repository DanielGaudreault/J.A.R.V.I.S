...
**Other Projects:**
- [My Search Page (J.A.R.V.I.S)](https://danielgaudreault.github.io/J.A.R.V.I.S/)
...
2. **Open in Browser:**
   - Navigate to [https://danielgaudreault.github.io/TOTAL-CYCLE-TIME/](https://danielgaudreault.github.io/TOTAL-CYCLE-TIME/) in your browser.
...
### My Search Page (J.A.R.V.I.S)

**Live Demo:** [J.A.R.V.I.S Search Page](https://danielgaudreault.github.io/J.A.R.V.I.S/)
...
- **images/**: Directory containing images used in the web page.
  ...
  - **MyLogo.png**: Main logo used in the web page.
...
- Replace the background image (`city wallpaper.jpg`) and main logo (`MyLogo.png`) with your own images if desired.
